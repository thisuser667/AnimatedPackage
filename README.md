...
Lazwiccodec and Lazwicimage are delphi's conversion to lazarus, for use it in lazarus in windows. Source code for these are not included. I will remove them if mandatory.
